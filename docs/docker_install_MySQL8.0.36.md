...
docker pull mysql/mysql:8.0.36
```
...
``` 
    ...
    --privileged=true \
    --name mysql8 \
    -e MYSQL_ROOT_PASSWORD=20240416ljgAw139919 \
    -v /opt/mysql/data:/var/lib/mysql:rw \
    -v /opt/mysql/logs:/var/log/mysql:rw \
	-v /opt/mysql/conf/my.cnf:/etc/my.cnf:rw \
    -v /etc/localtime:/etc/localtime:ro \
   mysql/mysql-server:8.0.36-1.2.2-server 
```
...
c00b6e6539bd        mysql/mysql-server:8.0.36-1.2.2-server   "/entrypoint.sh mysq…"   23 minutes ago      Up 23 minutes (healthy)      
